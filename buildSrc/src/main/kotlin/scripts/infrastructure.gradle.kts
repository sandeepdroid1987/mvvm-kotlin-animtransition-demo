...
tasks.register("runApp", Exec::class) {
    ...
    if (localProperties.exists()) {
        ...
        val applicationPackage = "com.urban.androidhomework.sample.${Default.BUILD_FLAVOR}.${Default.BUILD_TYPE}"
        val launchActivity = "com.urban.androidhomework.sample.core.navigation.RouteActivity"
